...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.98a0f4bdacd6223a0b70.module.css" />
  ...
  <title>FinalAssignment/7. Spacex-dash-app-api.py at main · CoroaPT/FinalAssignment</title>
  ...
  <meta name="request-id" content="C063:36C860:46FE34:60CD30:6675E746" data-turbo-transient="true" /><meta name="html-safe-nonce" content="ee370fc6ebd2a6f6b872c9c798b6018c8229885140249041048d231a11b34c60" data-turbo-transient="true" /><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHBzOi8vZ2l0aHViLmNvbS9Db3JvYVBUL0ZpbmFsQXNzaWdubWVudCIsInJlcXVlc3RfaWQiOiJDMDYzOjM2Qzg2MDo0NkZFMzQ6NjBDRDMwOjY2NzVFNzQ2IiwidmlzaXRvcl9pZCI6IjgxODc4NDg1OTg3OTc5NzEwNDEiLCJyZWdpb25fZWRnZSI6ImlhZCIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-turbo-transient="true" /><meta name="visitor-hmac" content="6e8751e3ea340e9f592890755768183a351393c8aa0efc41b603b446599787de" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="68703032" /><meta name="octolytics-actor-login" content="ragyaverma" /><meta name="octolytics-actor-hash" content="4e6c4d790a7640918868c015a625e51793f3ca8238dad8d42b138f18afdb4d8c" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/CoroaPT/FinalAssignment/blob/main/7.%20Spacex-dash-app-api.py" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/f0b2240835b97d0e8aa386daa7f33de5d729431a864096eb4c712a0e1910b8be/CoroaPT/FinalAssignment" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="FinalAssignment/7. Spacex-dash-app-api.py at main · CoroaPT/FinalAssignment" /><meta name="twitter:description" content="Contribute to CoroaPT/FinalAssignment development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/f0b2240835b97d0e8aa386daa7f33de5d729431a864096eb4c712a0e1910b8be/CoroaPT/FinalAssignment" /><meta property="og:image:alt" content="Contribute to CoroaPT/FinalAssignment development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="FinalAssignment/7. Spacex-dash-app-api.py at main · CoroaPT/FinalAssignment" /><meta property="og:url" content="https://github.com/CoroaPT/FinalAssignment/blob/main/7.%20Spacex-dash-app-api.py" /><meta property="og:description" content="Contribute to CoroaPT/FinalAssignment development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/68703032/ws?session=eyJ2IjoiVjMiLCJ1Ijo2ODcwMzAzMiwicyI6MTM5ODg2MjgzMywiYyI6MTIyNzMzODMyOSwidCI6MTcxOTAwMjk1MH0=--17fd1a3404f0e12a1cbedbd6dc0a4ff215ef5984c6a4f768e4f2423238ff7a67" data-refresh-url="/_alive" data-session-id="e6916ea9da501e1e9201469494e08a8531519af1b68ff838b8da50a5f27d6ad2">
...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/command-palette-a99cf9e9f4ca.js"></script>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-e4add0d0-fd96-49cc-b698-18cada93c899" id="dialog-show-dialog-e4add0d0-fd96-49cc-b698-18cada93c899" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-e4add0d0-fd96-49cc-b698-18cada93c899" aria-modal="true" aria-labelledby="dialog-e4add0d0-fd96-49cc-b698-18cada93c899-title" aria-describedby="dialog-e4add0d0-fd96-49cc-b698-18cada93c899-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-e4add0d0-fd96-49cc-b698-18cada93c899-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-e4add0d0-fd96-49cc-b698-18cada93c899" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-e4add0d0-fd96-49cc-b698-18cada93c899-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-5b8e4891-6766-4dd7-b8d7-1d0a26cfc73c" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-901081b5-7b3f-4c43-9da2-b331b8a3f837" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-d4ecdbc9-6479-477e-a333-5e262f9da1ef" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-a459c1f4-5792-4bf5-9594-b4e8850b8f5c" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-e3f82d97-bd7f-4843-b67c-52c6c1349c3c" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-7823ffd9-a249-41cf-b267-535e2a16b7cd" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-db3d56b6-7abc-4956-a78b-68a18421bf27" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-3c6cb1b8-325a-4aa0-88b7-d56eb599684a" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:CoroaPT/FinalAssignment" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="MeBmUGIv5HRpE6I0m4eDkYdz2CbOu9hdpjYU93RqSgCDbrfadHH61j0rJ5uU6lHB2iJPtFq6BuD-LRiOOSwlNQ" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="CoroaPT/FinalAssignment" data-current-org="" data-current-owner="CoroaPT" data-logged-in="true" data-copilot-chat-enabled="false" data-blackbird-indexed-repo-csrf="<input type=&quot;hidden&quot; value=&quot;5llu2vN-An0cvWpZGuUQxXm33AeBCplj_rBHC0nmqZAyudhF1iYXnWuQ4SJPp5ZPjtl5VIdyHmaeG0-gMR28TA&quot; data-csrf=&quot;true&quot; />">
  <div
...
<div class="AppHeader-search-whenRegular">
  <div class="AppHeader-search-wrap AppHeader-search-wrap--hasTrailing">
    ...
    <path d="m6.354 8.04-4.773 4.773a.75.75 0 1 0 1.061 1.06L7.945 8.57a.75.75 0 0 0 0-1.06L2.642 2.206a.75.75 0 0 0-1.06 1.061L6.353 8.04ZM8.75 11.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5h-5.5Z"></path>
      ...
      <tool-tip id="tooltip-c6522144-b75f-418b-9ed6-b86cdc9dddf9" for="AppHeader-commandPalette-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Command palette</tool-tip>
  </div>
</div>
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-64bba278-fe60-47ce-90b7-3bed79965ce7" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-64bba278-fe60-47ce-90b7-3bed79965ce7" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="ixUBXj8MmXQRgqbegpw16kw9FABRfNyHLLnJVujdSU0x0FtrFLX8ckswNX9Ygo7T5L-UVFuiORLFrFRZcEiO7g" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="qSMsTs6HBMiP9HKQxPK49PaEAoRUIK_JkjpVoIzJeW8m-pePvynLQDsPuGq7McRMsLqzlFsbZxTU0DdbaD35yA" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="aAQdbHgHAE5JumRtJD3xj94G0p-o-XEYLEtxvQdbtE1kOHkMVtYGopqUuUtHWWCvpAlxftR7cE-4vth3TYNGGQ" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="qCI0TiWmgs799ibwIIlqKT9YQPuMxBHeN7twLV4ouaCX8NkzhX2C2V1Wa8Y89u0YGYttXf9KpnO10DCy1pkMUQ" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button><tool-tip id="tooltip-1d79db41-0ef3-43cc-b584-2d02e28af073" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-4a4f8c04-6b50-471e-a250-16d8de8a9c5d" aria-labelledby="tooltip-3f00782f-e4f4-4aff-8c06-d9b2564d7c99" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-3f00782f-e4f4-4aff-8c06-d9b2564d7c99" for="icon-button-4a4f8c04-6b50-471e-a250-16d8de8a9c5d" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-99f180c9-0ae4-4525-a970-c9223e7a8bd5" aria-labelledby="tooltip-11a527b4-ebf7-48d0-b63b-938929e9140a" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-11a527b4-ebf7-48d0-b63b-938929e9140a" for="icon-button-99f180c9-0ae4-4525-a970-c9223e7a8bd5" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6Njg3MDMwMzIiLCJ0IjoxNzE5MDAyOTUxfQ==--99e8d6fe338c58d34dfeea3e62a7c008d4740fbbc308a4eb6587003ef6b19e37" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-button" popovertarget="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-overlay" aria-controls="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-list" aria-haspopup="true" aria-labelledby="tooltip-158bf504-9cdf-4ca2-b5de-dd4331a36c23" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-158bf504-9cdf-4ca2-b5de-dd4331a36c23" for="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-overlay" anchor="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-button" id="action-menu-65bbb8d6-4faa-42f5-846f-86f692ca4279-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-937c138a-2c90-4251-bde4-b3dbfd22538d" href="/CoroaPT/FinalAssignment" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-55cd6058-65ba-41f1-9517-dc252de035d5" href="/CoroaPT/FinalAssignment/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-f32c49cf-3045-43e9-a466-bbbb24d62d5b" href="/CoroaPT/FinalAssignment/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-6e27e5bc-bd69-4cd0-a937-767714d4c96a" href="/CoroaPT/FinalAssignment/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-bf55fc2e-08af-4d85-a639-25f855ea525b" href="/CoroaPT/FinalAssignment/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-c25be765-cdda-4f63-ae27-0ad7337d47b5" href="/CoroaPT/FinalAssignment/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-d244b991-3d56-4ef8-93bc-5a7fada7a381" href="/CoroaPT/FinalAssignment/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-f1e0e944-1688-4dda-a1e8-9d2a8e5d3b1e" aria-labelledby="tooltip-4bdf42da-d52d-4322-a547-67efcb823fc1" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-4bdf42da-d52d-4322-a547-67efcb823fc1" for="icon-button-f1e0e944-1688-4dda-a1e8-9d2a8e5d3b1e" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6Njg3MDMwMzIiLCJ0IjoxNzE5MDAyOTUxfQ==--99e8d6fe338c58d34dfeea3e62a7c008d4740fbbc308a4eb6587003ef6b19e37" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
>
  ...
  <details-dialog class="command-palette-details-dialog d-flex flex-column flex-justify-center height-fit" aria-label="Command palette">
    <command-palette
      ...
      return-to=/CoroaPT/FinalAssignment/blob/main/7.%20Spacex-dash-app-api.py
      user-id="68703032"
...
</button>    <tool-tip id="tooltip-48cfaee8-b661-470c-b9cb-aa89cdec46df" for="command-palette-clear-button" popover="manual" data-direction="w" data-type="label" data-view-component="true" class="sr-only position-absolute">Clear Command Palette</tool-tip>
</div>
...
<react-app
  ...
  initial-path="/CoroaPT/FinalAssignment/blob/main/7.%20Spacex-dash-app-api.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"1. Spacex-data-collection-api.pdf","path":"1. Spacex-data-collection-api.pdf","contentType":"file"},{"name":"2. Spacex-webscraping-api.pdf","path":"2. Spacex-webscraping-api.pdf","contentType":"file"},{"name":"3. Spacex-data-wrangling-api.pdf","path":"3. Spacex-data-wrangling-api.pdf","contentType":"file"},{"name":"4. Spacex-data-visualisation-api.ipynb","path":"4. Spacex-data-visualisation-api.ipynb","contentType":"file"},{"name":"5. Spacex-sqllite-api.pdf","path":"5. Spacex-sqllite-api.pdf","contentType":"file"},{"name":"6. Spacex-folium-map-api.ipynb","path":"6. Spacex-folium-map-api.ipynb","contentType":"file"},{"name":"7. Spacex-dash-app-api.py","path":"7. Spacex-dash-app-api.py","contentType":"file"},{"name":"8. Spacex-machine-learning-prediction-api.ipynb","path":"8. Spacex-machine-learning-prediction-api.ipynb","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"}],"totalCount":9}},"fileTreeProcessingTime":1.1822270000000001,"foldersToFetch":[],"repo":{"id":691261244,"defaultBranch":"main","name":"FinalAssignment","ownerLogin":"CoroaPT","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-09-13T16:22:00.000-04:00","ownerAvatar":"https://avatars.githubusercontent.com/u/143448065?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1694636521.954656","canEdit":true,"refType":"branch","currentOid":"3b46e8c461fc659448d6de4445647d71de2c6087"},"path":"7. Spacex-dash-app-api.py","currentUser":{"id":68703032,"login":"ragyaverma","userEmail":"ragyaverma29@gmail.com"},"blob":{"rawLines":["# Import required libraries","import pandas as pd","import dash","import dash_html_components as html","import dash_core_components as dcc","from dash.dependencies import Input, Output","import plotly.express as px","","# Read the airline data into pandas dataframe","spacex_df = pd.read_csv(\"spacex_launch_dash.csv\")","max_payload = spacex_df['Payload Mass (kg)'].max()","min_payload = spacex_df['Payload Mass (kg)'].min()","","# Create a dash application","app = dash.Dash(__name__)","","# Create an app layout","app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',","                                        style={'textAlign': 'center', 'color': '#503D36',","                                               'font-size': 40}),","                                # TASK 1: Add a dropdown list to enable Launch Site selection","                                # The default select value is for ALL sites","                                dcc.Dropdown(id='site-dropdown',","                                    options=[","                                        {'label': 'All Sites', 'value': 'ALL'},","                                        {'label': 'CCAFS LC-40', 'value': 'CCAFS LC-40'},","                                        {'label': 'CCAFS SLC-40', 'value': 'CCAFS SLC-40'},","                                        {'label': 'KSC LC-39A', 'value': 'KSC LC-39A'},","                                        {'label': 'VAFB SLC-4E', 'value': 'VAFB SLC-4E'}","                                        ],","                                    value='All sites',","                                    placeholder=\"Select a Launch Site here\",","                                    searchable=True","                                ),","                                html.Br(),","","                                # TASK 2: Add a pie chart to show the total successful launches count for all sites","                                # If a specific launch site was selected, show the Success vs. Failed counts for the site","                                # Function decorator to specify function input and output                               ","                                html.Div(dcc.Graph(id='success-pie-chart')),","                                html.Br(),","","                                html.P(\"Payload range (Kg):\"),","                                # TASK 3: Add a slider to select payload range","                                dcc.RangeSlider(id='payload-slider',","                                    min=0, max=10000, step=1000,","                                    marks={0: '0',1000: '1000',2000: '2000',3000: '3000', 4000: '4000',5000: '5000',6000: '6000',7000: '7000',8000: '8000',9000: '9000',10000: '10000'},","                                    value=[min_payload, max_payload]),","","                                # TASK 4: Add a scatter chart to show the correlation between payload and launch success","                                html.Div(dcc.Graph(id='success-payload-scatter-chart')),","                                ])","","# TASK 2:","# Add a callback function for `site-dropdown` as input, `success-pie-chart` as output","","@app.callback(","Output(component_id='success-pie-chart', component_property='figure'),","Input(component_id='site-dropdown', component_property='value')",")","","def get_pie(value):","    filtered_df = spacex_df","    if value == 'All Sites':","        fig = px.pie(filtered_df, values='class', names='Launch Site', title='Total Success Launches By Site')","        return fig","    else:","        filtered_df = spacex_df[spacex_df['Launch Site'] == value].groupby(['Launch Site', 'class']). \\","        size().reset_index(name='class count')","        title = f\"Total Success Launches for site {value}\"","        fig = px.pie(filtered_df,values='class count', names='class', title=title)","        return fig","","# TASK 4:","# Add a callback function for `site-dropdown` and `payload-slider` as inputs, `success-payload-scatter-chart` as output","@app.callback(Output(component_id='success-payload-scatter-chart', component_property='figure'),","              [Input(component_id='site-dropdown', component_property='value'),","              Input(component_id='payload-slider',component_property='value')])","","def scatter(site, payload):","    low, high = (payload[0], payload[1])","    mask = spacex_df[(spacex_df['Payload Mass (kg)'] \u003e= low) \u0026 (spacex_df['Payload Mass (kg)'] \u003c= high)]","    if site == 'ALL':","        fig = px.scatter(mask, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=\"Correlation between Payload and Success for All sites\")","        return fig  # Return an empty string for 'callback_test'","    else:","        mask_filtered = mask[mask['Launch Site'] == site]","        fig = px.scatter(mask_filtered, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f\"Correlation between Payload and Success for site {site}\")","        return fig  # Return an empty string for 'callback_test'","","# Run the app","if __name__ == '__main__':","    app.run_server()"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=pl-c\u003e# Import required libraries\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003epandas\u003c/span\u003e \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003epd\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003edash\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003edash_html_components\u003c/span\u003e \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003edash_core_components\u003c/span\u003e \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003edcc\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003edash\u003c/span\u003e.\u003cspan class=pl-s1\u003edependencies\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eInput\u003c/span\u003e, \u003cspan class=pl-v\u003eOutput\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eplotly\u003c/span\u003e.\u003cspan class=pl-s1\u003eexpress\u003c/span\u003e \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003epx\u003c/span\u003e","","\u003cspan class=pl-c\u003e# Read the airline data into pandas dataframe\u003c/span\u003e","\u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003epd\u003c/span\u003e.\u003cspan class=pl-en\u003eread_csv\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;spacex_launch_dash.csv\u0026quot;\u003c/span\u003e)","\u003cspan class=pl-s1\u003emax_payload\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026#39;Payload Mass (kg)\u0026#39;\u003c/span\u003e].\u003cspan class=pl-en\u003emax\u003c/span\u003e()","\u003cspan class=pl-s1\u003emin_payload\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026#39;Payload Mass (kg)\u0026#39;\u003c/span\u003e].\u003cspan class=pl-en\u003emin\u003c/span\u003e()","","\u003cspan class=pl-c\u003e# Create a dash application\u003c/span\u003e","\u003cspan class=pl-s1\u003eapp\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003edash\u003c/span\u003e.\u003cspan class=pl-v\u003eDash\u003c/span\u003e(\u003cspan class=pl-s1\u003e__name__\u003c/span\u003e)","","\u003cspan class=pl-c\u003e# Create an app layout\u003c/span\u003e","\u003cspan class=pl-s1\u003eapp\u003c/span\u003e.\u003cspan class=pl-s1\u003elayout\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eDiv\u003c/span\u003e(\u003cspan class=pl-s1\u003echildren\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e[\u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eH1\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026#39;SpaceX Launch Records Dashboard\u0026#39;\u003c/span\u003e,","                                        \u003cspan class=pl-s1\u003estyle\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e{\u003cspan class=pl-s\u003e\u0026#39;textAlign\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;center\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;color\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;#503D36\u0026#39;\u003c/span\u003e,","                                               \u003cspan class=pl-s\u003e\u0026#39;font-size\u0026#39;\u003c/span\u003e: \u003cspan class=pl-c1\u003e40\u003c/span\u003e}),","                                \u003cspan class=pl-c\u003e# TASK 1: Add a dropdown list to enable Launch Site selection\u003c/span\u003e","                                \u003cspan class=pl-c\u003e# The default select value is for ALL sites\u003c/span\u003e","                                \u003cspan class=pl-s1\u003edcc\u003c/span\u003e.\u003cspan class=pl-v\u003eDropdown\u003c/span\u003e(\u003cspan class=pl-s1\u003eid\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;site-dropdown\u0026#39;\u003c/span\u003e,","                                    \u003cspan class=pl-s1\u003eoptions\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e[","                                        {\u003cspan class=pl-s\u003e\u0026#39;label\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;All Sites\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;ALL\u0026#39;\u003c/span\u003e},","                                        {\u003cspan class=pl-s\u003e\u0026#39;label\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;CCAFS LC-40\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;CCAFS LC-40\u0026#39;\u003c/span\u003e},","                                        {\u003cspan class=pl-s\u003e\u0026#39;label\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;CCAFS SLC-40\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;CCAFS SLC-40\u0026#39;\u003c/span\u003e},","                                        {\u003cspan class=pl-s\u003e\u0026#39;label\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;KSC LC-39A\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;KSC LC-39A\u0026#39;\u003c/span\u003e},","                                        {\u003cspan class=pl-s\u003e\u0026#39;label\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;VAFB SLC-4E\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;VAFB SLC-4E\u0026#39;\u003c/span\u003e}","                                        ],","                                    \u003cspan class=pl-s1\u003evalue\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;All sites\u0026#39;\u003c/span\u003e,","                                    \u003cspan class=pl-s1\u003eplaceholder\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026quot;Select a Launch Site here\u0026quot;\u003c/span\u003e,","                                    \u003cspan class=pl-s1\u003esearchable\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-c1\u003eTrue\u003c/span\u003e","                                ),","                                \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eBr\u003c/span\u003e(),","","                                \u003cspan class=pl-c\u003e# TASK 2: Add a pie chart to show the total successful launches count for all sites\u003c/span\u003e","                                \u003cspan class=pl-c\u003e# If a specific launch site was selected, show the Success vs. Failed counts for the site\u003c/span\u003e","                                \u003cspan class=pl-c\u003e# Function decorator to specify function input and output                               \u003c/span\u003e","                                \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eDiv\u003c/span\u003e(\u003cspan class=pl-s1\u003edcc\u003c/span\u003e.\u003cspan class=pl-v\u003eGraph\u003c/span\u003e(\u003cspan class=pl-s1\u003eid\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;success-pie-chart\u0026#39;\u003c/span\u003e)),","                                \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eBr\u003c/span\u003e(),","","                                \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eP\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;Payload range (Kg):\u0026quot;\u003c/span\u003e),","                                \u003cspan class=pl-c\u003e# TASK 3: Add a slider to select payload range\u003c/span\u003e","                                \u003cspan class=pl-s1\u003edcc\u003c/span\u003e.\u003cspan class=pl-v\u003eRangeSlider\u003c/span\u003e(\u003cspan class=pl-s1\u003eid\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;payload-slider\u0026#39;\u003c/span\u003e,","                                    \u003cspan class=pl-s1\u003emin\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-c1\u003e0\u003c/span\u003e, \u003cspan class=pl-s1\u003emax\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-c1\u003e10000\u003c/span\u003e, \u003cspan class=pl-s1\u003estep\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-c1\u003e1000\u003c/span\u003e,","                                    \u003cspan class=pl-s1\u003emarks\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e{\u003cspan class=pl-c1\u003e0\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;0\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e1000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;1000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e2000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;2000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e3000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;3000\u0026#39;\u003c/span\u003e, \u003cspan class=pl-c1\u003e4000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;4000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e5000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;5000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e6000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;6000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e7000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;7000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e8000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;8000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e9000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;9000\u0026#39;\u003c/span\u003e,\u003cspan class=pl-c1\u003e10000\u003c/span\u003e: \u003cspan class=pl-s\u003e\u0026#39;10000\u0026#39;\u003c/span\u003e},","                                    \u003cspan class=pl-s1\u003evalue\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e[\u003cspan class=pl-s1\u003emin_payload\u003c/span\u003e, \u003cspan class=pl-s1\u003emax_payload\u003c/span\u003e]),","","                                \u003cspan class=pl-c\u003e# TASK 4: Add a scatter chart to show the correlation between payload and launch success\u003c/span\u003e","                                \u003cspan class=pl-s1\u003ehtml\u003c/span\u003e.\u003cspan class=pl-v\u003eDiv\u003c/span\u003e(\u003cspan class=pl-s1\u003edcc\u003c/span\u003e.\u003cspan class=pl-v\u003eGraph\u003c/span\u003e(\u003cspan class=pl-s1\u003eid\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;success-payload-scatter-chart\u0026#39;\u003c/span\u003e)),","                                ])","","\u003cspan class=pl-c\u003e# TASK 2:\u003c/span\u003e","\u003cspan class=pl-c\u003e# Add a callback function for `site-dropdown` as input, `success-pie-chart` as output\u003c/span\u003e","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003eapp\u003c/span\u003e.\u003cspan class=pl-en\u003ecallback\u003c/span\u003e(\u003c/span\u003e","\u003cspan class=pl-en\u003e\u003cspan class=pl-v\u003eOutput\u003c/span\u003e(\u003cspan class=pl-s1\u003ecomponent_id\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;success-pie-chart\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ecomponent_property\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;figure\u0026#39;\u003c/span\u003e),\u003c/span\u003e","\u003cspan class=pl-en\u003e\u003cspan class=pl-v\u003eInput\u003c/span\u003e(\u003cspan class=pl-s1\u003ecomponent_id\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;site-dropdown\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ecomponent_property\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e)\u003c/span\u003e","\u003cspan class=pl-en\u003e)\u003c/span\u003e","","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eget_pie\u003c/span\u003e(\u003cspan class=pl-s1\u003evalue\u003c/span\u003e):","    \u003cspan class=pl-s1\u003efiltered_df\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e","    \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003evalue\u003c/span\u003e \u003cspan class=pl-c1\u003e==\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026#39;All Sites\u0026#39;\u003c/span\u003e:","        \u003cspan class=pl-s1\u003efig\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003epx\u003c/span\u003e.\u003cspan class=pl-en\u003epie\u003c/span\u003e(\u003cspan class=pl-s1\u003efiltered_df\u003c/span\u003e, \u003cspan class=pl-s1\u003evalues\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;class\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003enames\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;Launch Site\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003etitle\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;Total Success Launches By Site\u0026#39;\u003c/span\u003e)","        \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003efig\u003c/span\u003e","    \u003cspan class=pl-k\u003eelse\u003c/span\u003e:","        \u003cspan class=pl-s1\u003efiltered_df\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[\u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026#39;Launch Site\u0026#39;\u003c/span\u003e] \u003cspan class=pl-c1\u003e==\u003c/span\u003e \u003cspan class=pl-s1\u003evalue\u003c/span\u003e].\u003cspan class=pl-en\u003egroupby\u003c/span\u003e([\u003cspan class=pl-s\u003e\u0026#39;Launch Site\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s\u003e\u0026#39;class\u0026#39;\u003c/span\u003e]). \\","        \u003cspan class=pl-en\u003esize\u003c/span\u003e().\u003cspan class=pl-en\u003ereset_index\u003c/span\u003e(\u003cspan class=pl-s1\u003ename\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;class count\u0026#39;\u003c/span\u003e)","        \u003cspan class=pl-s1\u003etitle\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s\u003ef\u0026quot;Total Success Launches for site \u003cspan class=pl-s1\u003e\u003cspan class=pl-kos\u003e{\u003c/span\u003e\u003cspan class=pl-s1\u003evalue\u003c/span\u003e\u003cspan class=pl-kos\u003e}\u003c/span\u003e\u003c/span\u003e\u0026quot;\u003c/span\u003e","        \u003cspan class=pl-s1\u003efig\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003epx\u003c/span\u003e.\u003cspan class=pl-en\u003epie\u003c/span\u003e(\u003cspan class=pl-s1\u003efiltered_df\u003c/span\u003e,\u003cspan class=pl-s1\u003evalues\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;class count\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003enames\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;class\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003etitle\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003etitle\u003c/span\u003e)","        \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003efig\u003c/span\u003e","","\u003cspan class=pl-c\u003e# TASK 4:\u003c/span\u003e","\u003cspan class=pl-c\u003e# Add a callback function for `site-dropdown` and `payload-slider` as inputs, `success-payload-scatter-chart` as output\u003c/span\u003e","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003eapp\u003c/span\u003e.\u003cspan class=pl-en\u003ecallback\u003c/span\u003e(\u003cspan class=pl-v\u003eOutput\u003c/span\u003e(\u003cspan class=pl-s1\u003ecomponent_id\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;success-payload-scatter-chart\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ecomponent_property\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;figure\u0026#39;\u003c/span\u003e),\u003c/span\u003e","\u003cspan class=pl-en\u003e              [\u003cspan class=pl-v\u003eInput\u003c/span\u003e(\u003cspan class=pl-s1\u003ecomponent_id\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;site-dropdown\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ecomponent_property\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e),\u003c/span\u003e","\u003cspan class=pl-en\u003e              \u003cspan class=pl-v\u003eInput\u003c/span\u003e(\u003cspan class=pl-s1\u003ecomponent_id\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;payload-slider\u0026#39;\u003c/span\u003e,\u003cspan class=pl-s1\u003ecomponent_property\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;value\u0026#39;\u003c/span\u003e)])\u003c/span\u003e","","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003escatter\u003c/span\u003e(\u003cspan class=pl-s1\u003esite\u003c/span\u003e, \u003cspan class=pl-s1\u003epayload\u003c/span\u003e):","    \u003cspan class=pl-s1\u003elow\u003c/span\u003e, \u003cspan class=pl-s1\u003ehigh\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e (\u003cspan class=pl-s1\u003epayload\u003c/span\u003e[\u003cspan class=pl-c1\u003e0\u003c/span\u003e], \u003cspan class=pl-s1\u003epayload\u003c/span\u003e[\u003cspan class=pl-c1\u003e1\u003c/span\u003e])","    \u003cspan class=pl-s1\u003emask\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[(\u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026#39;Payload Mass (kg)\u0026#39;\u003c/span\u003e] \u003cspan class=pl-c1\u003e\u0026gt;=\u003c/span\u003e \u003cspan class=pl-s1\u003elow\u003c/span\u003e) \u003cspan class=pl-c1\u003e\u0026amp;\u003c/span\u003e (\u003cspan class=pl-s1\u003espacex_df\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026#39;Payload Mass (kg)\u0026#39;\u003c/span\u003e] \u003cspan class=pl-c1\u003e\u0026lt;=\u003c/span\u003e \u003cspan class=pl-s1\u003ehigh\u003c/span\u003e)]","    \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003esite\u003c/span\u003e \u003cspan class=pl-c1\u003e==\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026#39;ALL\u0026#39;\u003c/span\u003e:","        \u003cspan class=pl-s1\u003efig\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003epx\u003c/span\u003e.\u003cspan class=pl-en\u003escatter\u003c/span\u003e(\u003cspan class=pl-s1\u003emask\u003c/span\u003e, \u003cspan class=pl-s1\u003ex\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;Payload Mass (kg)\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ey\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;class\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ecolor\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;Booster Version Category\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003etitle\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026quot;Correlation between Payload and Success for All sites\u0026quot;\u003c/span\u003e)","        \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003efig\u003c/span\u003e  \u003cspan class=pl-c\u003e# Return an empty string for \u0026#39;callback_test\u0026#39;\u003c/span\u003e","    \u003cspan class=pl-k\u003eelse\u003c/span\u003e:","        \u003cspan class=pl-s1\u003emask_filtered\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003emask\u003c/span\u003e[\u003cspan class=pl-s1\u003emask\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026#39;Launch Site\u0026#39;\u003c/span\u003e] \u003cspan class=pl-c1\u003e==\u003c/span\u003e \u003cspan class=pl-s1\u003esite\u003c/span\u003e]","        \u003cspan class=pl-s1\u003efig\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003epx\u003c/span\u003e.\u003cspan class=pl-en\u003escatter\u003c/span\u003e(\u003cspan class=pl-s1\u003emask_filtered\u003c/span\u003e, \u003cspan class=pl-s1\u003ex\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;Payload Mass (kg)\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ey\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;class\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003ecolor\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026#39;Booster Version Category\u0026#39;\u003c/span\u003e, \u003cspan class=pl-s1\u003etitle\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003ef\u0026quot;Correlation between Payload and Success for site \u003cspan class=pl-s1\u003e\u003cspan class=pl-kos\u003e{\u003c/span\u003e\u003cspan class=pl-s1\u003esite\u003c/span\u003e\u003cspan class=pl-kos\u003e}\u003c/span\u003e\u003c/span\u003e\u0026quot;\u003c/span\u003e)","        \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003efig\u003c/span\u003e  \u003cspan class=pl-c\u003e# Return an empty string for \u0026#39;callback_test\u0026#39;\u003c/span\u003e","","\u003cspan class=pl-c\u003e# Run the app\u003c/span\u003e","\u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003e__name__\u003c/span\u003e \u003cspan class=pl-c1\u003e==\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026#39;__main__\u0026#39;\u003c/span\u003e:","    \u003cspan class=pl-s1\u003eapp\u003c/span\u003e.\u003cspan class=pl-en\u003erun_server\u003c/span\u003e()"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/CoroaPT/FinalAssignment/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"7. Spacex-dash-app-api.py","displayUrl":"https://github.com/CoroaPT/FinalAssignment/blob/main/7.%20Spacex-dash-app-api.py?raw=true","headerInfo":{"blobSize":"4.84 KB","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"f1d97bb","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FCoroaPT%2FFinalAssignment%2Fblob%2Fmain%2F7.%2520Spacex-dash-app-api.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"93","truncatedSloc":"81"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/CoroaPT/FinalAssignment/blob/main/7.%20Spacex-dash-app-api.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/CoroaPT/FinalAssignment/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/CoroaPT/FinalAssignment/raw/main/7.%20Spacex-dash-app-api.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"spacex_df","kind":"constant","ident_start":250,"ident_end":259,"extent_start":250,"extent_end":299,"fully_qualified_name":"spacex_df","ident_utf16":{"start":{"line_number":9,"utf16_col":0},"end":{"line_number":9,"utf16_col":9}},"extent_utf16":{"start":{"line_number":9,"utf16_col":0},"end":{"line_number":9,"utf16_col":49}}},{"name":"max_payload","kind":"constant","ident_start":300,"ident_end":311,"extent_start":300,"extent_end":350,"fully_qualified_name":"max_payload","ident_utf16":{"start":{"line_number":10,"utf16_col":0},"end":{"line_number":10,"utf16_col":11}},"extent_utf16":{"start":{"line_number":10,"utf16_col":0},"end":{"line_number":10,"utf16_col":50}}},{"name":"min_payload","kind":"constant","ident_start":351,"ident_end":362,"extent_start":351,"extent_end":401,"fully_qualified_name":"min_payload","ident_utf16":{"start":{"line_number":11,"utf16_col":0},"end":{"line_number":11,"utf16_col":11}},"extent_utf16":{"start":{"line_number":11,"utf16_col":0},"end":{"line_number":11,"utf16_col":50}}},{"name":"app","kind":"constant","ident_start":431,"ident_end":434,"extent_start":431,"extent_end":456,"fully_qualified_name":"app","ident_utf16":{"start":{"line_number":14,"utf16_col":0},"end":{"line_number":14,"utf16_col":3}},"extent_utf16":{"start":{"line_number":14,"utf16_col":0},"end":{"line_number":14,"utf16_col":25}}},{"name":"get_pie","kind":"function","ident_start":3251,"ident_end":3258,"extent_start":3247,"extent_end":3775,"fully_qualified_name":"get_pie","ident_utf16":{"start":{"line_number":61,"utf16_col":4},"end":{"line_number":61,"utf16_col":11}},"extent_utf16":{"start":{"line_number":61,"utf16_col":0},"end":{"line_number":71,"utf16_col":18}}},{"name":"scatter","kind":"function","ident_start":4169,"ident_end":4176,"extent_start":4165,"extent_end":4894,"fully_qualified_name":"scatter","ident_utf16":{"start":{"line_number":79,"utf16_col":4},"end":{"line_number":79,"utf16_col":11}},"extent_utf16":{"start":{"line_number":79,"utf16_col":0},"end":{"line_number":88,"utf16_col":64}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/CoroaPT/FinalAssignment/branches":{"post":"fwXOXFGZPfKCLIfrCYDuRhoqoYft-OiUkECSJzfXG01oWScMHkNXQc03GbMZVkuFwARZBZTTqxjvPuAGXUbihA"},"/repos/preferences":{"post":"h4Az1CW7zPrIZx2HIlIvADMNt8xrMAGjd6q8UF7cSAxWnBe5Eqo6mxLB75_mUUUoIAFvIuOlRBcKeiEAFOLZKQ"}}},"title":"FinalAssignment/7. Spacex-dash-app-api.py at main · CoroaPT/FinalAssignment","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-s1>dcc</span>.<span class=pl-v>Dropdown</span>(<span class=pl-s1>id</span><span class=pl-c1>=</span><span class=pl-s>&#39;site-dropdown&#39;</span>,</div>
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>options</span><span class=pl-c1>=</span>[</div>
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                        {<span class=pl-s>&#39;label&#39;</span>: <span class=pl-s>&#39;All Sites&#39;</span>, <span class=pl-s>&#39;value&#39;</span>: <span class=pl-s>&#39;ALL&#39;</span>},</div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                        {<span class=pl-s>&#39;label&#39;</span>: <span class=pl-s>&#39;CCAFS LC-40&#39;</span>, <span class=pl-s>&#39;value&#39;</span>: <span class=pl-s>&#39;CCAFS LC-40&#39;</span>},</div>
<div id="LC27" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                        {<span class=pl-s>&#39;label&#39;</span>: <span class=pl-s>&#39;CCAFS SLC-40&#39;</span>, <span class=pl-s>&#39;value&#39;</span>: <span class=pl-s>&#39;CCAFS SLC-40&#39;</span>},</div>
<div id="LC28" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                        {<span class=pl-s>&#39;label&#39;</span>: <span class=pl-s>&#39;KSC LC-39A&#39;</span>, <span class=pl-s>&#39;value&#39;</span>: <span class=pl-s>&#39;KSC LC-39A&#39;</span>},</div>
<div id="LC29" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                        {<span class=pl-s>&#39;label&#39;</span>: <span class=pl-s>&#39;VAFB SLC-4E&#39;</span>, <span class=pl-s>&#39;value&#39;</span>: <span class=pl-s>&#39;VAFB SLC-4E&#39;</span>}</div>
<div id="LC30" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                        ],</div>
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>value</span><span class=pl-c1>=</span><span class=pl-s>&#39;All sites&#39;</span>,</div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>placeholder</span><span class=pl-c1>=</span><span class=pl-s>&quot;Select a Launch Site here&quot;</span>,</div>
<div id="LC33" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>searchable</span><span class=pl-c1>=</span><span class=pl-c1>True</span></div>
<div id="LC34" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                ),</div>
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-s1>html</span>.<span class=pl-v>Br</span>(),</div>
<div id="LC36" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC37" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-c># TASK 2: Add a pie chart to show the total successful launches count for all sites</span></div>
<div id="LC38" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-c># If a specific launch site was selected, show the Success vs. Failed counts for the site</span></div>
<div id="LC39" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-c># Function decorator to specify function input and output                               </span></div>
...
<div id="LC45" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-s1>dcc</span>.<span class=pl-v>RangeSlider</span>(<span class=pl-s1>id</span><span class=pl-c1>=</span><span class=pl-s>&#39;payload-slider&#39;</span>,</div>
<div id="LC46" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>min</span><span class=pl-c1>=</span><span class=pl-c1>0</span>, <span class=pl-s1>max</span><span class=pl-c1>=</span><span class=pl-c1>10000</span>, <span class=pl-s1>step</span><span class=pl-c1>=</span><span class=pl-c1>1000</span>,</div>
<div id="LC47" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>marks</span><span class=pl-c1>=</span>{<span class=pl-c1>0</span>: <span class=pl-s>&#39;0&#39;</span>,<span class=pl-c1>1000</span>: <span class=pl-s>&#39;1000&#39;</span>,<span class=pl-c1>2000</span>: <span class=pl-s>&#39;2000&#39;</span>,<span class=pl-c1>3000</span>: <span class=pl-s>&#39;3000&#39;</span>, <span class=pl-c1>4000</span>: <span class=pl-s>&#39;4000&#39;</span>,<span class=pl-c1>5000</span>: <span class=pl-s>&#39;5000&#39;</span>,<span class=pl-c1>6000</span>: <span class=pl-s>&#39;6000&#39;</span>,<span class=pl-c1>7000</span>: <span class=pl-s>&#39;7000&#39;</span>,<span class=pl-c1>8000</span>: <span class=pl-s>&#39;8000&#39;</span>,<span class=pl-c1>9000</span>: <span class=pl-s>&#39;9000&#39;</span>,<span class=pl-c1>10000</span>: <span class=pl-s>&#39;10000&#39;</span>},</div>
<div id="LC48" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                    <span class=pl-s1>value</span><span class=pl-c1>=</span>[<span class=pl-s1>min_payload</span>, <span class=pl-s1>max_payload</span>]),</div>
<div id="LC49" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC50" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-c># TASK 4: Add a scatter chart to show the correlation between payload and launch success</span></div>
<div id="LC51" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">                                <span class=pl-s1>html</span>.<span class=pl-v>Div</span>(<span class=pl-s1>dcc</span>.<span class=pl-v>Graph</span>(<span class=pl-s1>id</span><span class=pl-c1>=</span><span class=pl-s>&#39;success-payload-scatter-chart&#39;</span>)),</div>
...
<div id="LC54" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-c># TASK 2:</span></div>
<div id="LC55" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-c># Add a callback function for `site-dropdown` as input, `success-pie-chart` as output</span></div>
<div id="LC56" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC57" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>app</span>.<span class=pl-en>callback</span>(</span></div>
<div id="LC58" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en><span class=pl-v>Output</span>(<span class=pl-s1>component_id</span><span class=pl-c1>=</span><span class=pl-s>&#39;success-pie-chart&#39;</span>, <span class=pl-s1>component_property</span><span class=pl-c1>=</span><span class=pl-s>&#39;figure&#39;</span>),</span></div>
<div id="LC59" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en><span class=pl-v>Input</span>(<span class=pl-s1>component_id</span><span class=pl-c1>=</span><span class=pl-s>&#39;site-dropdown&#39;</span>, <span class=pl-s1>component_property</span><span class=pl-c1>=</span><span class=pl-s>&#39;value&#39;</span>)</span></div>
<div id="LC60" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>)</span></div>
<div id="LC61" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC62" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>get_pie</span>(<span class=pl-s1>value</span>):</div>
<div id="LC63" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">    <span class=pl-s1>filtered_df</span> <span class=pl-c1>=</span> <span class=pl-s1>spacex_df</span></div>
<div id="LC64" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">    <span class=pl-k>if</span> <span class=pl-s1>value</span> <span class=pl-c1>==</span> <span class=pl-s>&#39;All Sites&#39;</span>:</div>
<div id="LC65" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">        <span class=pl-s1>fig</span> <span class=pl-c1>=</span> <span class=pl-s1>px</span>.<span class=pl-en>pie</span>(<span class=pl-s1>filtered_df</span>, <span class=pl-s1>values</span><span class=pl-c1>=</span><span class=pl-s>&#39;class&#39;</span>, <span class=pl-s1>names</span><span class=pl-c1>=</span><span class=pl-s>&#39;Launch Site&#39;</span>, <span class=pl-s1>title</span><span class=pl-c1>=</span><span class=pl-s>&#39;Total Success Launches By Site&#39;</span>)</div>
<div id="LC66" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">        <span class=pl-k>return</span> <span class=pl-s1>fig</span></div>
<div id="LC67" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">    <span class=pl-k>else</span>:</div>
<div id="LC68" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">        <span class=pl-s1>filtered_df</span> <span class=pl-c1>=</span> <span class=pl-s1>spacex_df</span>[<span class=pl-s1>spacex_df</span>[<span class=pl-s>&#39;Launch Site&#39;</span>] <span class=pl-c1>==</span> <span class=pl-s1>value</span>].<span class=pl-en>groupby</span>([<span class=pl-s>&#39;Launch Site&#39;</span>, <span class=pl-s>&#39;class&#39;</span>]). \</div>
<div id="LC69" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">        <span class=pl-en>size</span>().<span class=pl-en>reset_index</span>(<span class=pl-s1>name</span><span class=pl-c1>=</span><span class=pl-s>&#39;class count&#39;</span>)</div>
<div id="LC70" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">        <span class=pl-s1>title</span> <span class=pl-c1>=</span> <span class=pl-s>f&quot;Total Success Launches for site <span class=pl-s1><span class=pl-kos>{</span><span class=pl-s1>value</span><span class=pl-kos>}</span></span>&quot;</span></div>
<div id="LC71" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-61 ">        <span class=pl-s1>fig</span> <span class=pl-c1>=</span> <span class=pl-s1>px</span>.<span class=pl-en>pie</span>(<span class=pl-s1>filtered_df</span>,<span class=pl-s1>values</span><span class=pl-c1>=</span><span class=pl-s>&#39;class count&#39;</span>, <span class=pl-s1>names</span><span class=pl-c1>=</span><span class=pl-s>&#39;class&#39;</span>, <span class=pl-s1>title</span><span class=pl-c1>=</span><span class=pl-s1>title</span>)</div>
<div id="LC72" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-k>return</span> <span class=pl-s1>fig</span></div>
<div id="LC73" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC74" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-c># TASK 4:</span></div>
<div id="LC75" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-c># Add a callback function for `site-dropdown` and `payload-slider` as inputs, `success-payload-scatter-chart` as output</span></div>
<div id="LC76" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>app</span>.<span class=pl-en>callback</span>(<span class=pl-v>Output</span>(<span class=pl-s1>component_id</span><span class=pl-c1>=</span><span class=pl-s>&#39;success-payload-scatter-chart&#39;</span>, <span class=pl-s1>component_property</span><span class=pl-c1>=</span><span class=pl-s>&#39;figure&#39;</span>),</span></div>
<div id="LC77" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>              [<span class=pl-v>Input</span>(<span class=pl-s1>component_id</span><span class=pl-c1>=</span><span class=pl-s>&#39;site-dropdown&#39;</span>, <span class=pl-s1>component_property</span><span class=pl-c1>=</span><span class=pl-s>&#39;value&#39;</span>),</span></div>
<div id="LC78" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>              <span class=pl-v>Input</span>(<span class=pl-s1>component_id</span><span class=pl-c1>=</span><span class=pl-s>&#39;payload-slider&#39;</span>,<span class=pl-s1>component_property</span><span class=pl-c1>=</span><span class=pl-s>&#39;value&#39;</span>)])</span></div>
<div id="LC79" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC80" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>scatter</span>(<span class=pl-s1>site</span>, <span class=pl-s1>payload</span>):</div>
<div id="LC81" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">    <span class=pl-s1>low</span>, <span class=pl-s1>high</span> <span class=pl-c1>=</span> (<span class=pl-s1>payload</span>[<span class=pl-c1>0</span>], <span class=pl-s1>payload</span>[<span class=pl-c1>1</span>])</div>
<div id="LC82" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">    <span class=pl-s1>mask</span> <span class=pl-c1>=</span> <span class=pl-s1>spacex_df</span>[(<span class=pl-s1>spacex_df</span>[<span class=pl-s>&#39;Payload Mass (kg)&#39;</span>] <span class=pl-c1>&gt;=</span> <span class=pl-s1>low</span>) <span class=pl-c1>&amp;</span> (<span class=pl-s1>spacex_df</span>[<span class=pl-s>&#39;Payload Mass (kg)&#39;</span>] <span class=pl-c1>&lt;=</span> <span class=pl-s1>high</span>)]</div>
<div id="LC83" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">    <span class=pl-k>if</span> <span class=pl-s1>site</span> <span class=pl-c1>==</span> <span class=pl-s>&#39;ALL&#39;</span>:</div>
<div id="LC84" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">        <span class=pl-s1>fig</span> <span class=pl-c1>=</span> <span class=pl-s1>px</span>.<span class=pl-en>scatter</span>(<span class=pl-s1>mask</span>, <span class=pl-s1>x</span><span class=pl-c1>=</span><span class=pl-s>&#39;Payload Mass (kg)&#39;</span>, <span class=pl-s1>y</span><span class=pl-c1>=</span><span class=pl-s>&#39;class&#39;</span>, <span class=pl-s1>color</span><span class=pl-c1>=</span><span class=pl-s>&#39;Booster Version Category&#39;</span>, <span class=pl-s1>title</span><span class=pl-c1>=</span><span class=pl-s>&quot;Correlation between Payload and Success for All sites&quot;</span>)</div>
<div id="LC85" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">        <span class=pl-k>return</span> <span class=pl-s1>fig</span>  <span class=pl-c># Return an empty string for &#39;callback_test&#39;</span></div>
<div id="LC86" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">    <span class=pl-k>else</span>:</div>
<div id="LC87" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">        <span class=pl-s1>mask_filtered</span> <span class=pl-c1>=</span> <span class=pl-s1>mask</span>[<span class=pl-s1>mask</span>[<span class=pl-s>&#39;Launch Site&#39;</span>] <span class=pl-c1>==</span> <span class=pl-s1>site</span>]</div>
<div id="LC88" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-79 ">        <span class=pl-s1>fig</span> <span class=pl-c1>=</span> <span class=pl-s1>px</span>.<span class=pl-en>scatter</span>(<span class=pl-s1>mask_filtered</span>, <span class=pl-s1>x</span><span class=pl-c1>=</span><span class=pl-s>&#39;Payload Mass (kg)&#39;</span>, <span class=pl-s1>y</span><span class=pl-c1>=</span><span class=pl-s>&#39;class&#39;</span>, <span class=pl-s1>color</span><span class=pl-c1>=</span><span class=pl-s>&#39;Booster Version Category&#39;</span>, <span class=pl-s1>title</span><span class=pl-c1>=</span><span class=pl-s>f&quot;Correlation between Payload and Success for site <span class=pl-s1><span class=pl-kos>{</span><span class=pl-s1>site</span><span class=pl-kos>}</span></span>&quot;</span>)</div>
<div id="LC89" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-k>return</span> <span class=pl-s1>fig</span>  <span class=pl-c># Return an empty string for &#39;callback_test&#39;</span></div>
<div id="LC90" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC91" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-c># Run the app</span></div>
<div id="LC92" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>if</span> <span class=pl-s1>__name__</span> <span class=pl-c1>==</span> <span class=pl-s>&#39;__main__&#39;</span>:</div>
<div id="LC93" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>app</span>.<span class=pl-en>run_server</span>()</div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"night"}</script></div>
</react-app>
</turbo-frame>
